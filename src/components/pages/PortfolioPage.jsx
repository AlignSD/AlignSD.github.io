...
permissions. </p>
                            <a href="https://social-media-merng-app.herokuapp.com/" className="portBtn btn btn-primary portfolioButtons" target="_blank">Live Product</a>
                            <a href="https://github.com/AlignSD/SocialMediaApp" className="portBtn btn btn-primary portfolioButtons" target="_blank">Github Page</a>
                        </div>
                    </div>
                    <div className="card text-center portfolio-card mr-5 ml-5 mb-5  smallScreenPort col-lg-5 col-sm">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://alignsd.github.io/Plan.it/" className="portBtn btn btn-primary margin-right-20 portfolioButtons" target="_blank">Live Product</a>
                            <a href="https://github.com/AlignSD/Ticket_Bits" className="portBtn btn btn-primary mx-20 portfolioButtons" target="_blank">Github Page</a>
                        </div>
                    </div>
                    ...
                    <div className="card text-center portfolio-card mr-5 ml-5 mb-5  smallScreenPort col-lg-5 col-sm" >
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://alignsd.github.io/Tonelist/index.html" className="portBtn btn btn-primary portfolioButtons" target="_blank">Live Product</a>
                            <a href="https://github.com/AlignSD/Tonelist" className="portBtn btn btn-primary portfolioButtons" target="_blank">Github Page</a>
                        </div>
                    </div>
                    <div className="card text-center portfolio-card mr-5 ml-5 mb-5  smallScreenPort col-lg-5 col-sm">
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://alignsd.github.io/Plan.it/" className="portBtn btn btn-primary margin-right-20 portfolioButtons" target="_blank">Live Product</a>
                            <a href="https://github.com/AlignSD/Plan.it" className="portBtn btn btn-primary mx-20 portfolioButtons" target="_blank">Github Page</a>
                        </div>
                    </div>
                    <div className="w-100"></div>
                    ...
                    <div className="card text-center portfolio-card mr-5 ml-5 mb-5  smallScreenPort col-lg-5 col-sm" >
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://alignsd.github.io/4Castr" className="portBtn btn btn-primary portfolioButtons" target="_blank">Live Product</a>
                            <a href="https://github.com/AlignSD/4Castr" className="portBtn btn btn-primary portfolioButtons" target="_blank">Github Page</a>
                        </div>
                    </div>
                    ...
                    <div className="card text-center portfolio-card mr-5 ml-5 mb-5 smallScreenPort col-lg-5 col-sm" >
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://alignsd.github.io/NuPass" className="btn btn-primary portBtn portfolioButtons" target="_blank">Live Product</a>
                            <a href="https://github.com/AlignSD/NuPass" className="portBtn btn btn-primary portfolioButtons" target="_blank">Github Page</a>
                        </div>
                    </div>
