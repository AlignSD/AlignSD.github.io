  ...
  return (
    ...
    <Navbar sticky="top" collapseOnSelect expand="md" variant="dark" style={navbarbackground} className="navBarBackground">
      ...
      <Navbar.Collapse id="responsive-navbar-nav smallScreenNavLinks " >
        <div className="navbar-brand col-sm-4 col-md-2 col-lg-2 smallScreenNavLinks navLinkColor">Evan Alioto</div><br />
        <Nav className="col-sm-4 col-md-7 col-lg-8 text-align-center" id="navLinks">
        ...
        {/* <div className=" "> */}
        <ul className="row  col-sm-4 col-md-3 col-lg-2 socialMediaLinks align-content-center">
          <li>
            <a className="nav-link socialLinks" href="https://www.github.com/AlignSD" aria-label="GitHub" target="_blank" rel="noreferrer">
