  ...
  return (
    ...
    <Navbar sticky="top" collapseOnSelect expand="lg" bg="dark" variant="dark">
      ...
      <Navbar.Collapse id="responsive-navbar-nav">
        <div className="col-sm-4">Evan Alioto</div><br />
        <Nav className="col-sm-4 text-align-center justify-content-center" id="navLinks">

          <Link className="nav-link pageLink" smooth to="#home">Home</Link>
          <Link className="nav-link pageLink" smooth to="#portfolio">Portfolio</Link>
        ...
        <div className="col-sm-4 ">
          <ul className="row justify-content-end align-content-center">
            <li>
